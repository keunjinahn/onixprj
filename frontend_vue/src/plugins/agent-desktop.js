 ...
 * @version v0.0.2g
 */
import * as C from '@/plugins/common'

// Construct a MeshServer object
export default function CreateAgentRemoteDesktop(canvasid, scrolldiv) {
  var obj = {}
  obj.CanvasId = canvasid;
  if (typeof canvasid === 'string') obj.CanvasId = C.Q(canvasid);
  ...
  obj.send = function (x) {
    if (obj.debugmode > 1) {
      console.log("KSend(" + x.length + "): " + C.rstr2hex(x));
    }
    if (obj.parent != null) {
      obj.parent.send(x);
    }
  ...
  obj.DoPendingOperations = function () {
    ...
    for (var i = 0; i < obj.PendingOperations.length; i++) { // && KillDraw < tilesDrawn
      ...
      if (Msg[0] == (obj.TilesDrawn + 1)) {
        if (Msg[1] == 1) {
          obj.ProcessCopyRectMsg(Msg[2]);
        } else if (Msg[1] == 2) {
          obj.Canvas.drawImage(Msg[2], obj.rotX(Msg[3], Msg[4]), obj.rotY(Msg[3], Msg[4]));
          delete Msg[2];
        }
        obj.PendingOperations.splice(i, 1);
        // delete Msg;   ==> Parsing error: Deleting local variable in strict mode
        Msg = undefined;
        obj.TilesDrawn++;
        if (obj.TilesDrawn == obj.tilesReceived && obj.KillDraw < obj.TilesDrawn) {
          obj.KillDraw = obj.TilesDrawn = obj.tilesReceived = 0;
        }
        return true;
      }
    }
    if (obj.oldie && obj.PendingOperations.length > 0) {
      obj.TilesDrawn++;
    }
    return false;
  }
  ...
  obj.ProcessCopyRectMsg = function (str) {
    ...
    obj.Canvas.drawImage(obj.Canvas.canvas, SX, SY, WIDTH, HEIGHT, DX, DY, WIDTH, HEIGHT);
  }
  ...
  obj.SendCompressionLevel = function (type, level, scaling, frametimer) {
    ...
    if (scaling) {
      obj.ScalingLevel = scaling;
    }
    if (frametimer) {
      obj.FrameRateTimer = frametimer;
    }
  ...
  obj.ProcessScreenMsg = function (width, height) {
    ...
    while (obj.PendingOperations.length > 0) {
      obj.PendingOperations.shift();
    }
    obj.SendCompressionLevel(1);
    obj.SendUnPause();
    if (obj.onScreenSizeChange != null) {
      obj.onScreenSizeChange(obj, obj.ScreenWidth, obj.ScreenHeight, obj.CanvasId);
    }
  }
  ...
  obj.ProcessDataEx = function (str) {
    ...
    if (obj.debugmode > 1) {
      console.log("KRecv(" + str.length + "): " + C.rstr2hex(str.substring(0, Math.min(str.length, 40))));
    }
    if (str.length < 4) return;
    var cmdmsg = null,
      X = 0,
      Y = 0,
      command = C.ReadShort(str, 0),
      cmdsize = C.ReadShort(str, 2),
      jumboAdd = 0;
    if ((command == 27) && (cmdsize == 8)) {
      // Jumbo packet
      if (str.length < 12) return;
      command = C.ReadShort(str, 8)
      cmdsize = C.ReadInt(str, 4);
    ...
    if ((cmdsize != str.length) && (obj.debugmode > 0)) {
      console.log(cmdsize, str.length, cmdsize == str.length);
    }
    if ((command >= 18) && (command != 65) && (command != 88)) {
      console.error("Invalid KVM command " + command + " of size " + cmdsize);
      console.log("Invalid KVM data", str.length, C.rstr2hex(str.substring(0, 40)) + '...');
      return;
    }
    ...
    if (command == 3 || command == 4 || command == 7) {
      ...
      if (obj.debugmode > 0) {
        console.log("CMD" + command + " at X=" + X + " Y=" + Y);
      }
    }
    ...
    switch (command) {
      ...
      case 4: // Tile Copy
        ...
        if (obj.TilesDrawn == obj.tilesReceived) {
          ...
          obj.PendingOperations.push([++obj.tilesReceived, 1, cmdmsg]);
        }
        break;
      case 7: // Screen size
      ...
      case 11: // GetDisplays
        var selectedDisplay = 0,
          displays = {},
          dcount = ((str.charCodeAt(4) & 0xFF) << 8) + (str.charCodeAt(5) & 0xFF);
        if (dcount > 0) {
          ...
          for (var i = 0; i < dcount; i++) {
            ...
            if (disp == 65535) {
              displays[disp] = 'All Displays';
            } else {
              displays[disp] = 'Display ' + disp;
            }
          }
        }
        //console.log('Get Displays', displays, selectedDisplay, rstr2hex(str));
        if (obj.onDisplayinfo != null) {
          obj.onDisplayinfo(obj, displays, selectedDisplay);
        }
        break;
      case 12: // SetDisplay
      ...
      case 16: // MNG_KVM_CONNECTCOUNT
        obj.connectioncount = C.ReadInt(str, 4);
      ...
      case 65: // Alert
        ...
        if (str[0] != '.') {
          ...
          if (obj.parent != null) {
            ...
            if (obj.parent.onConsoleMessageChange) {
              obj.parent.onConsoleMessageChange(obj.parent, str);
            }
          }
        } else {
      ...
      case 88: // MNG_KVM_MOUSE_CURSOR
        ...
        if (cursorNum > mouseCursors.length) {
          cursorNum = 0;
        }
  ...
  obj.SendKeyMsgKC = function (action, kc) {
    ...
    if (typeof action == 'object') {
      for (var i in action) {
        obj.SendKeyMsgKC(action[i][0], action[i][1]);
      }
    } else {
  ...
  obj.sendcad = function () {
    obj.SendCtrlAltDelMsg();
  }

  obj.SendCtrlAltDelMsg = function () {
    if (obj.State == 3) {
      obj.send(String.fromCharCode(0x00, obj.InputType.CTRLALTDEL, 0x00, 0x04));
    }
  }
  ...
  obj.SendTouchMsg2 = function (id, flags) {
    ...
    for (var k in obj.TouchArray) {
      if (k == id) {
        ...
        if (obj.TouchArray[k].f == 1) {
          flags2 = 0x00010000 | 0x00000002 | 0x00000004;
          obj.TouchArray[k].f = 3;
          str += "START" + k;
        } // POINTER_FLAG_DOWN
        else if (obj.TouchArray[k].f == 2) {
          flags2 = 0x00040000;
          str += "STOP" + k;
        } // POINTER_FLAG_UP
    ...
    if (Object.keys(obj.TouchArray).length == 0 && obj.touchtimer != null) {
      clearInterval(obj.touchtimer);
      obj.touchtimer = null;
    }
  }
    ...
    if (Action != null && obj.Canvas != null) {
      ...
      if (X >= 0 && X <= obj.Canvas.canvas.width && Y >= 0 && Y <= obj.Canvas.canvas.height) {
        ...
        if (Action == obj.KeyAction.UP || Action == obj.KeyAction.DOWN) {
          if (event.which) {
            ((event.which == 1) ? (Button = obj.MouseButton.LEFT) : ((event.which == 2) ? (Button = obj.MouseButton.MIDDLE) : (Button = obj.MouseButton.RIGHT)));
          } else if (event.button) {
            ((event.button == 0) ? (Button = obj.MouseButton.LEFT) : ((event.button == 1) ? (Button = obj.MouseButton.MIDDLE) : (Button = obj.MouseButton.RIGHT)));
          }
        } else if (Action == obj.KeyAction.SCROLL) {
          if (event.detail) {
            Delta = (-1 * (event.detail * 120));
  ...
  obj.GetDisplayNumbers = function () {
    obj.send(String.fromCharCode(0x00, 0x0B, 0x00, 0x04));
  } // Get Terminal display
  obj.SetDisplay = function (number) {
    console.log('Set display', number);
    obj.send(String.fromCharCode(0x00, 0x0C, 0x00, 0x06, number >> 8, number & 0xFF));
  } // Set Terminal display
  obj.intToStr = function (x) {
    return String.fromCharCode((x >> 24) & 0xFF, (x >> 16) & 0xFF, (x >> 8) & 0xFF, x & 0xFF);
  }
  obj.shortToStr = function (x) {
  ...
  obj.xxMouseMove = function (e) {
    if (obj.State == 3) obj.SendMouseMsg(obj.KeyAction.NONE, e);
    if (e.preventDefault) e.preventDefault();
    if (e.stopPropagation) e.stopPropagation();
    return false;
  }
  obj.xxMouseUp = function (e) {
    if (obj.State == 3) obj.SendMouseMsg(obj.KeyAction.UP, e);
    if (e.preventDefault) e.preventDefault();
    if (e.stopPropagation) e.stopPropagation();
    return false;
  }
  obj.xxMouseDown = function (e) {
    if (obj.State == 3) obj.SendMouseMsg(obj.KeyAction.DOWN, e);
    if (e.preventDefault) e.preventDefault();
    if (e.stopPropagation) e.stopPropagation();
    return false;
  }
  obj.xxMouseDblClick = function (e) {
    if (obj.State == 3) obj.SendMouseMsg(obj.KeyAction.DBLCLICK, e);
    if (e.preventDefault) e.preventDefault();
    if (e.stopPropagation) e.stopPropagation();
    return false;
  }
  obj.xxDOMMouseScroll = function (e) {
    if (obj.State == 3) {
      obj.SendMouseMsg(obj.KeyAction.SCROLL, e);
      return false;
    }
    return true;
  }
  obj.xxMouseWheel = function (e) {
    if (obj.State == 3) {
      obj.SendMouseMsg(obj.KeyAction.SCROLL, e);
      return false;
    }
  ...
  obj.handleKeys = function (e) {
    if (obj.stopInput == true || obj.State != 3) return false;
  ...
  obj.handleKeyUp = function (e) {
    ...
    if (obj.firstUpKeys.length < 5) {
      ...
      if ((obj.firstUpKeys.length == 5)) {
        var j = obj.firstUpKeys.join(',');
        if ((j == '16,17,91,91,16') || (j == '16,17,18,91,92')) {
          obj.stopInput = true;
        }
      }
    }
  ...
  obj.handleKeyDown = function (e) {
    if (obj.stopInput == true || obj.State != 3) return false;
    if (e.keyCode == 16) {
      obj.shiftPressed = true;
    }
    if (e.keyCode == 17) {
      obj.ctrlPressed = true;
    }
    if (e.keyCode == 18) {
      obj.altPressed = true;
    }
  ...
  obj.handleReleaseKeys = function () {
    if (obj.shiftPressed) {
      obj.SendKeyMsgKC(obj.KeyAction.UP, 16);
    } // Shift
    if (obj.ctrlPressed) {
      obj.SendKeyMsgKC(obj.KeyAction.UP, 17);
    } // Ctrl
    if (obj.altPressed) {
      obj.SendKeyMsgKC(obj.KeyAction.UP, 18);
    } // Alt
  ...
  obj.mousedblclick = function (e) {
    if (obj.stopInput == true) return false;
    return obj.xxMouseDblClick(e);
  }
  obj.mousedown = function (e) {
    if (obj.stopInput == true) return false;
    return obj.xxMouseDown(e);
  }
  obj.mouseup = function (e) {
    if (obj.stopInput == true) return false;
    return obj.xxMouseUp(e);
  }
  obj.mousemove = function (e) {
    if (obj.stopInput == true) return false;
    return obj.xxMouseMove(e);
  }
  obj.mousewheel = function (e) {
    if (obj.stopInput == true) return false;
    return obj.xxMouseWheel(e);
  }
  ...
  obj.xxMsTouchEvent = function (evt) {
    ...
    if (evt.type == 'MSPointerDown' || evt.type == 'MSPointerMove' || evt.type == 'MSPointerUp') {
      ...
      var X = evt.offsetX * (obj.Canvas.canvas.width / obj.CanvasId.clientWidth);
      var Y = evt.offsetY * (obj.Canvas.canvas.height / obj.CanvasId.clientHeight);
      ...
      if (!obj.TouchArray[id]) obj.TouchArray[id] = {
        x: X,
        y: Y
      };
  ...
  obj.xxTouchStart = function (e) {
    ...
    if (obj.touchenabled == 0 || obj.touchenabled == 1) {
      ...
      obj.SendMouseMsg(obj.KeyAction.DOWN, e);
    } else {
      var Offsets = obj.GetPositionOfControl(obj.Canvas.canvas);
      for (var i in e.originalEvent.changedTouches) {
        ...
        if (!obj.TouchArray[id]) {
          obj.TouchArray[id] = {
            x: (e.originalEvent.touches[i].pageX - Offsets[0]) * (obj.Canvas.canvas.width / obj.CanvasId.clientWidth),
            y: (e.originalEvent.touches[i].pageY - Offsets[1]) * (obj.Canvas.canvas.height / obj.CanvasId.clientHeight),
            f: 1
          };
        }
      }
      if (Object.keys(obj.TouchArray).length > 0 && obj.touchtimer == null) {
        obj.touchtimer = setInterval(function () {
          obj.SendTouchMsg2(256, 0);
        }, 50);
      }
    }
  }
  ...
  obj.xxTouchEnd = function (e) {
    ...
    if (obj.touchenabled == 0 || obj.touchenabled == 1) {
      ...
      e.pageX = obj.LastX;
      e.pageY = obj.LastY;
      obj.SendMouseMsg(obj.KeyAction.UP, e);
    } else {
      for (var i in e.originalEvent.changedTouches) {
        if (!e.originalEvent.changedTouches[i].identifier) continue;
        var id = e.originalEvent.changedTouches[i].identifier % 256;
  ...
  obj.GrabMouseInput = function () {
    ...
    if (navigator.userAgent.match(/mozilla/i)) c.DOMMouseScroll = obj.xxDOMMouseScroll;
    else c.onmousewheel = obj.xxMouseWheel;
  ...
  obj.UnGrabMouseInput = function () {
    ...
    c.MSPointerUp = null;
    if (navigator.userAgent.match(/mozilla/i)) c.DOMMouseScroll = null;
    else c.onmousewheel = null;
    obj.xxMouseInputGrab = false;
  }
  ...
  obj.setRotation = function (x) {
    ...
    if (obj.rotation == 1 || obj.rotation == 3) {
      rw = obj.Canvas.canvas.height;
      rh = obj.Canvas.canvas.width;
    }
    ...
    if (obj.rotation == 0 || obj.rotation == 2) {
      obj.Canvas.canvas.height = rw;
      obj.Canvas.canvas.width = rh;
    }
    if (obj.rotation == 1 || obj.rotation == 3) {
      obj.Canvas.canvas.height = rh;
      obj.Canvas.canvas.width = rw;
    }
    obj.Canvas.setTransform(1, 0, 0, 1, 0, 0);
  ...
  // Private method
  obj.MuchTheSame = function (a, b) {
    return (Math.abs(a - b) < 4);
  }
  obj.Debug = function (msg) {
    console.log(msg);
  }
  obj.getIEVersion = function () {
    var r = -1;
    if (navigator.appName == 'Microsoft Internet Explorer') {
      var ua = navigator.userAgent;
      var re = new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");
      if (re.exec(ua) != null) r = parseFloat(RegExp.$1);
    }
    return r;
  }
  obj.haltEvent = function (e) {
    if (e.preventDefault) e.preventDefault();
    if (e.stopPropagation) e.stopPropagation();
    return false;
  }
