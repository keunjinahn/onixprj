...
-- 테이블 데이터 onixdb.customer_tbl:~3 rows (대략적) 내보내기
...
-- 테이블 onixdb.event_log_tbl 구조 내보내기
...
-- 테이블 데이터 onixdb.event_log_tbl:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `event_log_tbl` DISABLE KEYS */;
/*!40000 ALTER TABLE `event_log_tbl` ENABLE KEYS */;

-- 테이블 onixdb.event_tbl 구조 내보내기
...
-- 테이블 데이터 onixdb.event_tbl:~241 rows (대략적) 내보내기
...
-- 테이블 onixdb.fire_receiver_tbl 구조 내보내기
...
-- 테이블 데이터 onixdb.fire_receiver_tbl:~2 rows (대략적) 내보내기
/*!40000 ALTER TABLE `fire_receiver_tbl` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `fire_receiver_tbl` ENABLE KEYS */;

-- 테이블 onixdb.fire_repeater_tbl 구조 내보내기
...
-- 테이블 데이터 onixdb.fire_repeater_tbl:~4 rows (대략적) 내보내기
/*!40000 ALTER TABLE `fire_repeater_tbl` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `fire_repeater_tbl` ENABLE KEYS */;

-- 테이블 onixdb.fire_sensor_tbl 구조 내보내기
...
-- 테이블 데이터 onixdb.fire_sensor_tbl:~20 rows (대략적) 내보내기
/*!40000 ALTER TABLE `fire_sensor_tbl` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `fire_sensor_tbl` ENABLE KEYS */;

-- 테이블 onixdb.tbcarinfo 구조 내보내기
CREATE TABLE IF NOT EXISTS `tbcarinfo` (
...
-- 테이블 데이터 onixdb.tbcarinfo:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `tbcarinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbcarinfo` ENABLE KEYS */;

-- 테이블 onixdb.tbdriverinfo 구조 내보내기
CREATE TABLE IF NOT EXISTS `tbdriverinfo` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
-- 테이블 데이터 onixdb.tbdriverinfo:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `tbdriverinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbdriverinfo` ENABLE KEYS */;

-- 테이블 onixdb.tbeventlog 구조 내보내기
...
-- 테이블 데이터 onixdb.tbeventlog:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `tbeventlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbeventlog` ENABLE KEYS */;

-- 테이블 onixdb.user_tbl 구조 내보내기
...
-- 테이블 데이터 onixdb.user_tbl:~4 rows (대략적) 내보내기
/*!40000 ALTER TABLE `user_tbl` DISABLE KEYS */;
INSERT INTO `user_tbl` (`id`, `user_id`, `user_pwd`, `user_name`, `user_status`, `user_role`, `token`) VALUES
	(1, 'admin', 'daef4953b9783365cad6615223720506cc46c5167cd16ab500fa597aa08ff964eb24fb19687f34d7665f778fcb6c5358fc0a5b81e1662cf90f73a2671c53f991', '관리자', 1, 1, '0847f5540d7efeb005ca68c3e8ab6962c2087fae'),
...
-- 트리거 onixdb.tg_event_update 구조 내보내기
